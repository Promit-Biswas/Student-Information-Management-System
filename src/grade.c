...
void add_grade()
{
    ...
    node_to_find = search_node(grade_root, &id_to_store, grade_student_compare);
...
void delete_grade()
{
    ...
    node_to_delete = search_node(grade_root, &id_to_delete, grade_student_compare);
...
void update_grade()
{
    ...
    node_to_update = search_node(grade_root, &id_to_update, grade_student_compare);
    ...
    grade_t *grade = (grade_t *)node_to_update->data_ptr;
